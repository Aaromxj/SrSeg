...
class Cityscapes(BaseDataset):
    def __init__(self, 
        ...
        '''
        self.label_mapping = {-1: ignore_label, 0: 1, 
                              1: 2, 2: 3, 
                              3: 4}
        ...
        self.label_mapping = {-1: ignore_label, 0: 1, 
                              ...
                              3: 4, 4: 5, 
                              5: 6, 6: 7, 
                              7: 8, 8: ignore_label, 9: ignore_label, 
    ...
    def read_files(self):
        ...
        if 'test' in self.list_path:
            for item in self.img_list:
                image_path = item
                print(os.path.splitext(os.path.basename(image_path[0]))[0])
    ...
    def __getitem__(self, index):
        ...
        image = cv2.imread(os.path.join(self.root,'cityscapes',item["img"]),
                           cv2.IMREAD_COLOR)
        #image = loadmat(os.path.join(self.root,'cityscapes',item["img"]))['HSI']
        size = image.shape
    ...
    def multi_scale_inference(self, model, image, scales=[1], flip=False):
        ...
        for scale in scales:
            ...
            if scale <= 1.0:
                ...
                preds = preds[:, 0:7, 0:height, 0:width]
            else:
                ...
                for r in range(rows):
                    for c in range(cols):
                        ...
                        preds[:,:,h0:h1,w0:w1] += pred[:,0:7, 0:h1-h0, 0:w1-w0]
                        count[:,:,h0:h1,w0:w1] += 1
                preds = preds / count
